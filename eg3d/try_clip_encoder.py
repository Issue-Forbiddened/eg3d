...
im = Image.open("/root/eg3d/eg3d/WechatIMG463.jpg").convert("RGB")
...
original_clip_embed=original_clip.get_image_features(image_inputs.pixel_values.to(original_clip.device))

original_clip_text_embed=original_clip.get_text_features(text_input_ids.to(original_clip.device))
