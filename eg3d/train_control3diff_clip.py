                        ...
                        if args.use_ema:
                            ...
                            if args.verify_text:
                                ...
                                if args.additional_sample:
                                    ...
                                    accelerator.log({f'reverse_process_normal_text_additional_sample_prompt_{original_prompt_with_line}':wandb.Image(reverse_guidance_process_list_text[0].numpy())},step=global_step)
