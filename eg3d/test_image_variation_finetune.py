                ...
                with torch.no_grad():
                    ...
                    if args.additional_sample:
                        ...
                        for cfg_scale in [1.5,2.,4.]:
                            for encoder_state_scale in [5.,10., 20.,]:
...
# CUDA_VISIBLE_DEVICES=0 python test_image_variation_finetune.py --train_batch_size=1 --log_step_interval=2500 --checkpointing_steps=5000 --resume_from_checkpoint=latest --output=outputs/image_variation_finetune_freeze_attentions --wandb_offline  --prediction_type=epsilon --dataset_path dataset_v1_test --additional_sample=16

# CUDA_VISIBLE_DEVICES=0 python test_image_variation_finetune.py --train_batch_size=1 --log_step_interval=2500 --checkpointing_steps=5000 --resume_from_checkpoint=latest --output=outputs/image_variation_finetune_freeze_attentions --wandb_offline  --prediction_type=epsilon --dataset_path dataset_modified_caption --additional_sample=16