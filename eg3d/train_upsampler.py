...
class Encoder(ModelMixin,ConfigMixin):
    ...
    def __init__(
        ...
        in_channels=96,
        out_channels=96,
        up_block_types=("UpEncoderBlock2D",),
        block_out_channels=(64,),
        layers_per_block=2,
        norm_num_groups=32,
        act_fn="silu",
        ...
        for i, up_block_type in enumerate(up_block_types):
            prev_output_channel=in_channels if i == 0 else block_out_channels[i - 1]
            up_block=get_up_block(
                up_block_type,
                in_channels=in_channels if i == 0 else block_out_channels[i - 1],
        ...
        if norm_num_groups is not None:
            self.conv_norm_out = nn.GroupNorm(
                num_channels=block_out_channels[0], num_groups=norm_num_groups,
            )
